...
- `bench tts`: one GPU cold chars_8 run, then the same resident model with Japanese chunks of 5/8/12/20/about 30/about 50 characters and five warm runs per size. `first_audio_equivalent` includes cold model load; `warm_first_audio_equivalent` starts at inference.
